...
if (!fs.existsSync(wikiDir)) {
  ...
  console.log('git clone https://github.com/iyotee/HeadForge.wiki.git docs-wiki');
  process.exit(1);
}
...
try {
  ...
  if (status.trim()) {
    ...
    console.log('📖 View your wiki at: https://github.com/iyotee/HeadForge/wiki');
  } else {
...
console.log('• Update with custom message: node scripts/update-wiki.js "Your message"');
console.log('• Clone wiki: git clone https://github.com/iyotee/HeadForge.wiki.git docs-wiki');
