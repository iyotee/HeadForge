...
try {
  ...
  execSync('gh repo create headforge --public --description "Professional code header generator browser extension" --clone=false', { stdio: 'inherit' });
  ...
  console.log('3. Check GitHub Actions: https://github.com/satoshiba/headforge/actions');
  ...
  console.log('3. Description: Professional code header generator browser extension');
